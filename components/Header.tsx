  ...
  return (
    <header className="h-16 glass border-b flex items-center justify-between px-8 z-40 bg-[#020617]/50 backdrop-blur-2xl">
      ...
      <div className="flex items-center space-x-6">
        ...
        <div className="flex items-center space-x-2 text-slate-500 hover:text-white cursor-pointer transition-colors px-3 py-1.5 rounded-xl hover:bg-slate-800/40">
          <Globe size={18} />
        ...
        <button 
          onClick={onLogout}
          className="flex items-center space-x-3 text-rose-500 hover:bg-rose-500/10 px-5 py-2.5 rounded-xl transition-all duration-300 border border-transparent hover:border-rose-500/20 active:scale-95 group shadow-xl"
        >
